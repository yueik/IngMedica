<div>
    ...
    <div class="modal fade" wire:ignore.self id="addDireccion" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <form wire:submit.prevent="{{ $editModal ? 'updateDireccion' : 'createDireccion' }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('piso') is-invalid @enderror" name="piso"
                                wire:model.defer="state.piso">
                            @error('piso')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('dpto') is-invalid @enderror" name="dpto"
                                wire:model.defer="state.dpto">
                            @error('dpto')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('barrio') is-invalid @enderror" name="barrio"
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td>
                        <a type="button" class="btn btn-warning" wire:click.prevent="editDireccion({{ $direccion }})">
