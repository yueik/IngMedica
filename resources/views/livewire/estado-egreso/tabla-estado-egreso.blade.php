<div>
    <div class="px-0 py-3 flex justify-between">
        <button wire:click.prevent="addEstadoEgreso" type="button" class="btn btn-primary">Agregar</button>
        <input type="text" wire:model="search" placeholder="Buscar...">
    </div>

    <div class="modal fade" wire:ignore.self id="addEstadoEgreso" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form wire:submit.prevent="{{ $editModal ? 'updateEstadoEgreso' : 'createEstadoEgreso' }}">
                    @csrf
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td>{{ $estado->estado }}</td>
                    <td>
                        <a type="button" class="btn btn-warning" wire:click.prevent="editEstadoEgreso({{ $estado }})">
